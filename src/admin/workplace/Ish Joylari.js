...
import { StyleSheet, View, Text, Pressable,FlatList, ScrollView, RefreshControl,SafeAreaView } from "react-native";
import { Color, Border, Padding,FontSize } from "./GlobalStyles";
import {MaterialIcons} from '@expo/vector-icons'
import SyncStorge from 'sync-storage'

import WorkPlaceModal from './component/workPlaceModal/WorkPlaceModal'
...
const onRefresh = () => {
  ...
  return (
    <View style={styles.personalInfo}>
      <WorkPlaceModal setModalVisible={setModalVisible} modaVisible={modaVisible} />
                ...
                workPlace.map((item,index) => (
                  <View key={index} style={styles.tablecontainer1}>
                    <View style={styles.headItemcontainer2}>
                      ...
                      <View style={styles.headItemrow1}>
                        <Text>{item.nameaOfWorkPlace}</Text>
                      </View>
                      <View style={styles.headItemrow1}>
                        <Text>2</Text>
                      </View>
      ...
      <View style={[styles.top, styles.topFlexBox]}>
        ...
        <Text style={styles.text2Typo}>Ish Joylari</Text>
       <Pressable >
        <Image
            style={[styles.bell11, styles.bell11Layout]}
            contentFit="cover"
            source={require("./workpalceasstets/plus.png")}
          />
       </Pressable>
      </View>
