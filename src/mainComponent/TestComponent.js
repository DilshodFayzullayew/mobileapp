...
export default TestComponent = () => {
  ...
  const navOther = () => {
    nav.navigate('Quiz', { itemId: 42, otherParam: 'Hello' });
  }
  const products = [
    {
      id: 1,
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={{alignItems:'center', marginTop:10}}><Text style={{fontSize:23, alignItems:'center'}}>Bazaviy Testlar</Text></View>
        <FlatList
                ...
                <View style={styles.card} onPress={handlePress}>
                  <View style={styles.cardContent}>
                    ...
                    {product.images.map((image, index) => (
                      <TouchableOpacity onPress={navOther} key={`${product.id}_${index}`}>
