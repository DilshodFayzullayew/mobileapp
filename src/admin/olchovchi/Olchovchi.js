...
export default function Olchovchi() {
  ...
  const fetchdata = async (id) => {
    fetch('http://192.168.137.1:8080/api/checker/get_worker/' + id, {
      method: 'GET',
      headers: {
      ...
      .then(responseData => {
        ...
        setMasters(responseData['userList'])    
      })
      .catch(error => {
          console.log(error);
      });
  ...
  return (
                  ...
                  <View key={index} style={styles.tablecontainer1}>
                    <View style={styles.headItemcontainer2}>
                      <View style={styles.headItemrow1}>
                        <Text style={styles.texttable}>{item.fullname}</Text>
                      </View>
                      <View style={styles.headItemrow1}>
    ...
    <View style={styles.info}>
      <MaterialIcons
        ...
        contentFit="cover"
      />
      <Text style={styles.choudaryAoun}>Faol O`lchovchilar</Text>
      <Text style={styles.choudaryaoun121gmailcom}>
        Bugungi eng faol Masterlar
      </Text>
